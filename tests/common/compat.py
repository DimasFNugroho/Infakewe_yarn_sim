"""PyChrono compatibility helpers for tests on the tutorials branch.

This branch intentionally does not include the `chrono_yarn` package, so test
helpers must remain self-contained.
"""
